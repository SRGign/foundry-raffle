...
contract Raffle is VRFConsumerBaseV2Plus {
    ...
    function enterRaffle() external payable{
            // Function logic for entering the raffle goes here
         ...
         * The following should be true ind order for upkeepNeeded to be true:
         * 1. The time interval has passed between raffle runs
         * 2. The lottery is in an "open" state
         * 3. The contract has ETH
         * 4. Implicitly, your subscription is funded with LINK
         * @param - ignored 
         * @return upkeepNeeded - true if the lottery should have a winner picked
         * @return - ignored 
         */
